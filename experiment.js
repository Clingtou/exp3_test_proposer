...
const PROLIFIC_COMPLETION_CODE = "CES2TC4K";
...
function roseChartHtml(condition, options = {}) {
  ...
  const calloutCenterGap = compact ? 120 : 70;
  const lineGap = 40;
...
function instructionTrial() {
  const renderHtml = function () {
    ...
    return shellHtml(`
      ...
      <p>You will decide how much of the <span class="doc-red">100 cents</span> to keep for yourself and how much to offer to the receiver. There is no correct split.</p>
      <ul>
